...
Phase 1 complete. Phase 2 complete. Full TX→RX loopback verified in QEMU. Phase 5 (tasks 20–23) complete: AES-128-CMAC auth, key_id rotation, 55 tests passing. Phase 6 complete (tasks 25–28): config schema, TDD tests, NVS persistence, all modules migrated to `ts_config_get()` lookups; 63 tests passing.
